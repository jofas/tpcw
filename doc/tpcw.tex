...
schedule alone the speed can increase by a factor of 2.7.
...
Further ideas for a follow-up benchmark testing changes
...
It should be noted that this chapter discusses some ideas
on why the performance of different schedules
differ.
...
(\romannumeral 1) higher cost of indexing a
multidimensional array with bigger indices and
(\romannumeral 2) $\cos(x)$ takes more time for bigger $x$.
