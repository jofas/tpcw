...
\def\titl{Threaded Programming coursework: benchmarking
  OpenMP schedules}
...
and performs element-wise computations on matrices (using
nested do-loops, not array operations).
It contains two of these matrix operations---in this
...
which determines the divide of the iterations of the loop
...
effect the execution speed of the two critical
...
(\texttt{ifort}) version 17.0.2 \citep[see][]{ifort}.
